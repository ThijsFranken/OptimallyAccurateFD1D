...
if (npTF==3);                    
    ...
    mu=a_mu*x+b_mu;
        ...
        H2(m,n)=0.;
            ...
            if (n == 1)                %calculating the Tm(m-1), Hm(m-1)
             ...
             elseif(n==2)            %calculating the Tm(m), Hm(m)
             ...
             elseif (n == 3)         %calculating the Tm(m+1), Hm(m+1)
...
elseif (npTF==5);
    ...
    mu=a_mu*x+b_mu;
        ...
        H2(m,n)=0.;
            ...
            if (n == 1)                %calculating the Tm(m-2), Hm(m-2)
             ...
             elseif(n == 2)            %calculating the Tm(m-1), Hm(m-1)
             ...
             elseif (n == 3)         %calculating the Tm(m), Hm(m)
             ...
             elseif(n == 4)            %calculating the Tm(m+1), Hm(m+1)
              ...
              elseif (n == 5)                %calculating the Tm(m+2), Hm(m+2)
...
elseif (npTF==7);
    ...
    mu=a_mu*x+b_mu;
        ...
        H2(m,n)=0.;
             ...
             if (n == 1)                %calculating the Tm(m-3), Hm(m-3)
             ...
             elseif(n == 2)            %calculating the Tm(m-2), Hm(m-2)
             ...
             elseif(n == 4)            %calculating the Tm(m), Hm(m)
             ...
             elseif (n == 5)                %calculating the Tm(m+1), Hm(m+1)
             ...
             elseif(n == 6)            %calculating the Tm(m+2), Hm(m+2)
             ...
             elseif (n == 7)                %calculating the Tm(m+3), Hm(m+3)
